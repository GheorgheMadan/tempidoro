...
export default function useProducts() {
    ...
    async function fetchProducts({
        category, search = '', limit = 40, offset = 0, append = false, filters, isPromo, isEvidence, isNew
    }) {
        ...
        if (!category) {
            // 2. Caso globale (homepage senza categoria)
            url += `http://localhost:3000/api/products?isNew=${isNew}&isPromo=${isPromo}&limit=${limit}&offset=${offset}`
        }
        ...
        try {
            ...
            // ✅ salvo il primo totale UNA sola volta per questo contesto
            if (!append && offset === 0 && firstTotal === null) {
