...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <main>
                {/* SECTION SLIDER */}
                <div className="evidence-section products-section">
                    <h1 className="text-center text-title mb-5 title">In evidenza dallo shop online</h1>
                    {products === null && !loading && <h2>Erorre del server riprova più tardi</h2>}
                    {products?.length === 0 && !loading && <h2>Nessun prodotto disponibile in evidenza</h2>}
                    {loading && <Spinner />}
                    {!loading && <div className="evidence-products">
                        <Slider {...settings}>
